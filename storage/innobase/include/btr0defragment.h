...
extern simple_atomic_counter<> btr_defragment_compression_failures;
extern simple_atomic_counter<> btr_defragment_failures;
extern simple_atomic_counter<> btr_defragment_count;
